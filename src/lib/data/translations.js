export default {
  de: {
    ...
    'project_output.repository': {text: 'Code-Repository'},
    'project_output.data': {text: 'Daten'},
    'project_output.video': {text: 'Video'},
    'project_output.report': {text: 'Bericht'},
