            ...
            <div class="">
              {#if text_only === false}
                <div class="grid xl:grid-cols-2">
                  <div class="flex flex-col items-center py-12 px-3">
                    ...
                    {/if}
                    <p class="text-lg font-semibold drop-shadow-md">
              ...
              {:else}
                <div class=" px-3">
                  ...
                  <p
                    class="line-clamp-7 pt-6 text-right text-lg font-semibold drop-shadow-md"
                  >
                    {quote.quote_id.translations[0].subtitle}
                  </p>
                </div>
