<script>
  ...
  $: if (map) {
    if (map.isStyleLoaded()) {
      ...
      map.setLayoutProperty('state', 'text-field', ['get', 'name:' + $locale]);
      map.setLayoutProperty('city', 'text-field', ['get', 'name:' + $locale]);
      map.setLayoutProperty('town', 'text-field', ['get', 'name:' + $locale]);
    }
  }
</script>
...
>
<div
  class="map_height w-full rounded border border-neutral-25"
