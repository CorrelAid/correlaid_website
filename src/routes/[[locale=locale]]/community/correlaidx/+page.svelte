<script>
            ...
            new Popup({ closeOnClick: true, offset: 10, closeButton: true })
                .setHTML(
                    `<div class="pt-2 px-2 pb-1 flex justify-center align-center">
                        ${external_svg}
                    <a class="font-bold text-tertiary hover:underline text-sm font-sans text-base" href="/${"" ? get_locale($page.params) == "de" : "en"}/community/correlaidx/${lcs.properties.city}">${lcs.properties.name}</a>
                    </div>`
                )
    ...
    <div class=" relative px-2">
        ...
        >
        <div
            class="w-full border border-neutral-25 rounded "
            id="map"
