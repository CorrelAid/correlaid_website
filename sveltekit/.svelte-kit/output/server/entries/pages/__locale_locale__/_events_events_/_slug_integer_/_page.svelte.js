import { c as create_ssr_component, d as add_attribute, a as subscribe, v as validate_component, e as escape } from "../../../../../chunks/index3.js";
import { p as page_key } from "../../../../../chunks/page_key.js";
import { e as gen_date, h as gen_time } from "../../../../../chunks/helpers.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container mx-auto pt-8 px-4"}">${validate_component(Html, "Html").$$render(
    $$result,
    {
      source: `<h1>${event.translations[0].title}</h1>`,
      width: "text"
    },
    {},
    {}
  )}
  <div id="${"info"}" class="${"p-4 border border-neutral-25 rounded mt-8 mx-auto svelte-1guifgo"}"><p class="${"flex pb-2"}"><span class="${"flex my-auto fill-neutral"}">${validate_component(Calendar, "Calendar").$$render($$result, { width: 20, height: 20 }, {}, {})}</span> <span class="${"pl-4 my-auto"}">${escape(gen_date(event.date, $locale))}</span></p>
    <p class="${"flex pb-2"}"><span class="${"flex my-auto fill-neutral"}">${validate_component(Time, "Time").$$render($$result, { width: 20, height: 20 }, {}, {})}</span>
      <span class="${"pl-4 my-auto"}">${escape(gen_time(event.start_time, $locale))} - ${escape(gen_time(event.end_time, $locale))} (CET)</span></p>
    ${event.translations[0].location ? `<p class="${"flex pb-2"}"><span class="${"flex my-auto fill-neutral"}">${validate_component(Location, "Location").$$render($$result, { width: 20, height: 20 }, {}, {})}</span> <span class="${"pl-4 my-auto"}">${escape(event.translations[0].location)}</span></p>` : ``}
