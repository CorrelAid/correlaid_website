...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container mx-auto py-6"}"><div class="${"relative"}"><a href="${"https://www.maptiler.com"}" class="${"absolute left-4 bottom-4 z-10"}"><img src="${"https://api.maptiler.com/resources/logo.svg"}" alt="${"MapTiler logo"}"></a>
        <div class="${"w-full border border-neutral-25 svelte-19revja"}" id="${"map"}"${add_attribute("this", mapContainer, 0)}></div></div>
</div>`;
});
export {
  Page as default
