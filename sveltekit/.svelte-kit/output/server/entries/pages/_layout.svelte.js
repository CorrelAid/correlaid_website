...
const Mobile_Menu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$drawer ? `<div class="${"z-30 absolute w-screen h-screen lg:hidden"}" id="${"drawer"}"><div class="${"flex flex-col justify-between w-5/6 h-screen bg-white border-r absolute left-0 z-30"}" id="${"drawer-sidenav"}"><nav aria-label="${"Main Nav"}" class="${"flex flex-col pt-7 pl-7"}"><ul class="${"text-base-content text-2xl space-y-3"}"><li><div class="${"inline-flex items-center justify-center"}"><a class="${"tracking-wide"}"${add_attribute("href", $t("navbar.about").url, 0)}>${escape($t("navbar.about").text)}</a></div></li>
                    <li><div class="${"inline-flex items-center"}"><a class="${"tracking-wide w-56"}"${add_attribute("href", $t("navbar.data4good").url, 0)}>${escape($t("navbar.data4good").text)}</a>
                            <button>${validate_component(Dropdown_Icon, "DropdownIcon").$$render($$result, { height: 30, width: 30 }, {}, {})}</button></div></li>
                    ${data4good_toggle ? `<ul class="${"font-light text-base-content tracking-wide text-base space-y-3"}"><li><a class="${"hover:text-primary transition"}"${add_attribute("href", $t("navbar.data4good.projects").url, 0)}>${escape($t("navbar.data4good.projects").text)}</a></li>
                            <li><a class="${"hover:text-primary transition"}"${add_attribute("href", $t("navbar.data4good.nonprofits").url, 0)}>${escape($t("navbar.data4good.nonprofits").text)}</a></li></ul>` : ``}
...
<header aria-label="${"Site Header"}" class="${"w-screen z-10 border-b border-neutral-25"}"><div class="${"mx-auto max-w-screen-xl px-4 sm:px-6 xl:px-8 "}"><div class="${"flex items-center justify-between xl:grid grid-cols-10"}"><div class="${"flex items-center gap-12 col-span-2"}"><a class="${"block text-teal-600 mx-auto"}"${add_attribute("href", $t("navbar.home").url, 0)}><span class="${"sr-only"}">Home</span>
					${validate_component(CorrelAid_Logo, "CorrelAid_Logo").$$render($$result, { width: 100, height: 100 }, {}, {})}</a></div>
			<div class="${"xl:block flex-col hidden col-span-6"}"><div class="${"flex mb-3 mt-1"}"><div class="${"mx-auto"}"><nav aria-label="${"Site Nav"}"><ul class="${"flex items-center gap-6 font-light text-base-content tracking-wide"}">${validate_component(Subnav_Link, "SubnavLink").$$render(
    $$result,
    {
    ...
    {}
			...
			<div class="${"xl:flex items-center hidden gap-4 mx-auto col-span-2"}">${validate_component(Link_Button, "LinkButton").$$render(
    $$result,
    {
      text: $t("navbar.donate").text,
      href: $t("navbar.donate").url,
...
${data4good_toggle ? `<div class="${"w-screen hidden absolute z-20 xl:block"}" style="${"top: " + escape($header_height + 1, true) + "px"}"><div class="${"mx-auto max-w-screen-xl px-4 sm:px-6 xl:px-8 "}"><div class="${"px-4 sm:px-6 xl:px-8 items-center justify-between grid grid-cols-10 "}"><div class="${"col-span-2"}"></div>
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { builder } = $$props;
  let { image_id } = $$props;
  if ($$props.builder === void 0 && $$bindings.builder && builder !== void 0)
    $$bindings.builder(builder);
  if ($$props.image_id === void 0 && $$bindings.image_id && image_id !== void 0)
    $$bindings.image_id(image_id);
  $$unsubscribe_header_height();
  return `<section class="${"relative bg-cover bg-center bg-no-repeat"}" style="${"background-image: url(" + escape(`https://6xdv3yb3.directus.app/assets/${image_id}`, true) + "); height: calc(100vh - " + escape($header_height, true) + "px)"}"><div class="${"absolute inset-0 bg-gradient-to-r from-secondary/75 to-primary/75"}"></div>

    <div class="${"absolute m-auto w-screen-sm left-0 top-1/4 xl:top-2/4 xl:left-1/4"}"><div class="${""}">${builder ? `${each(builder, (section) => {
    return `${section.collection == "button_groups" ? `<div class="${"fix space-x-2 px-4"}">${each(section.item.builder, (button) => {
      return `${validate_component(Link_Button, "LinkButton").$$render(
        ...
        {}
                        ...
                        </div>` : `${section.collection == "text_fields" ? `<h2 class="${"px-4 pb-8 font-bold text-4xl text-white tracking-wide"}">${escape(section.item.translations[0].text)}</h2>` : ``}`}`;
  })}` : ``}</div></div></section>`;
});
...
<div class="${"flex flex-col items-center min-h-screen text-neutral"}"${add_attribute("style", $drawer ? "max-height: 100vh; overflow-y:hidden" : "", 0)}>${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
    ...
    return `${section.collection == "heros" ? `${validate_component(Hero, "Hero").$$render(
      ...
      {}
						...
						</div>` : `${section.collection == "carousel" ? `<div class="${"container mx-auto"}">${validate_component(Carousel_1, "Carousel").$$render($$result, { data: section.item.builder }, {}, {})}
